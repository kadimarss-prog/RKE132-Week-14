...
class Hero(Character):
    ...
    def attack(self, other):
        ...
        if damage == 0:
            print(f"{self.name} attacts with {self.weapon}, but {other.name} damages! ")

        if damage > other.hp:
            print(f"{self.name} attacts with {self.weapon} for {damage}. Critical hit! ")
...
class Villain(Character):
    ...
    def attact(self, other):
        ...
        if damage == 0:
            print(f"{self.name} attacts with {self.weapon}, but {other.name} dodges! ")
